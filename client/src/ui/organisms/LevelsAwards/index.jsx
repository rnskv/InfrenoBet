        ...
        <Container>
            ...
            <Description>
                <p>
                    ...
                    <Yellow> { getExchangedSum(0.01) } </Yellow>
                    за <Blue> 1 еденицу опыта </Blue>.
                    Накапливая опыт*, Вы повышаете свой уровень.
                    <b>*После достижения определенного уровня - опыт не обнуляется,
                        вы продолжаете накапливать его.</b>
                </p>
            </Description>
