        ...
        <Container>
            ...
            <Description>
                <p>
                    ...
                    {' '}
                    за 1 еденицу опыта.
                    Накапливая опыт, Вы поднимаете свой уровень.
                    С тем, сколько нужно опыта для достижения
                    конкретного уровня, можно ознакомиться ниже.
                    После достижения определенного уровня - опыт не обнуляется,
                    вы продолжаете накапливать его.
                </p>
                <p>
                    Доступ к награде появляется сразу после достижения необходимого уровня.
                </p>
            </Description>
